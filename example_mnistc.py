...
x = load('mnist_c/fog/train_images.npy')
y = load('mnist_c/fog/train_labels.npy')
y = torch.from_numpy(y.reshape(60000)).long()
metric = loss_landscapes.metrics.Loss(criterion, torch.from_numpy(x.reshape(60000, 784)).float(), y)
...
plt.savefig('mnistc_results/loss_mnistc_1d.png')
plt.show()
...
# save plot to file and show
plt.savefig('mnistc_results/loss_mnistc_2d.png')
plt.show()
...
# save plot to file and show
plt.savefig('mnistc_results/loss_mnistc_3d.png')
plt.show()

save('mnistc_results/loss_data_fin_mnistc.npy', loss_data_fin)
save('mnistc_results/loss_data_fin_3d_mnistc.npy', loss_data_fin_3d)